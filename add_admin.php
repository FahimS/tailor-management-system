...
<!-- .............content here.............. -->
	...
	<div class="adform templete clear">
        ...
        $gender = $_POST['gender'];
				...
				$sql = "INSERT into adlogin(name,username,gender,email,password,mobile,address) values('$name','$username','$gender','$email','$password','$mobile','$address')";
		...
		<form method="post" action="">
			...
			<input type="text" name="name" id="num" placeholder="Enter Admin's Name"><br><br>
			
      <label>Admin's Username:</label><br>
      <input type="text" name="username" id="num" placeholder="Enter Admins's Username"><br><br>
        ...
        <label for="gender">Gender:</label><br>
			...
			<label>Admin's Mobiile Nub:</label><br>
