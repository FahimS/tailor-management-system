	...
	<div class="form templete clear">
		...
		<?php 
			if (isset($_POST['register'])) {
				...
				$sql = "INSERT into creg(name,email,password,gender,mobile,address) values('$name','$email','$password','$gender','$mobile','$address')";
		...
		<form method="post" action="">
			...
			<input type="text" name="name" id="num" placeholder="Enter Customer's Name" required=""><br><br>
			...
			<label>Customer's Mobiile Nub:</label><br>
			<input type="tel" name="mobile" placeholder="Enter Customer's Mobile Number" id="num" required=""><br><br>

			<label>Customer's Address:</label><br>
			<textarea id="text" name="address" rows="5" cols="50" placeholder="Enter Customer's Address Here" required=""></textarea><br><br>
