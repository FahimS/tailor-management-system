 ...
 <div class="title templete clear">
		...
		<div class="container templete clear">
			...
			<div class="right templete clear">
				<marquee behavior=alternate><h4>Login First</h4></marquee>
				<div class="formbox2 templete clear">
					
					<form>
						
						<a style="text-decoration: none" href="clogin.php"><p>Customer</p></a>
						<a style="text-decoration: none" href="tlogin.php"><p>Tailor</p></a>
						<a style="text-decoration: none" href="adlogin.php"><p>Admin</p></a>
						<!-- <p>Password</p> -->
