    ...
    <section id="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                <li>Dashboard</li>
                <li >></li>
                <li class="active">List of order</li>
            </ol>
        </div>
    </section>
                      ...
                      <div class="panel-body">
                        <table class="table table-striped table-hover">
                            <thead>
                                ...
                                <!--  php code for showing total order list -->
                                <?php
                                    global $conn;
                            ...
                            <tr>
                                <td><?php echo "<a href='show_info.php?trans_id=$trans_id' style='text-decoration-line: underline;'>$trans_id</a>";?></td>
