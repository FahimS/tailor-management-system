                    ...
                    <div class="panel panel-default ">
                      ...
                      <div class="panel-body">
                        <table class="table table-striped table-hover">
                            ...
                            <!--  php code for showing pending list -->
                            <?php
                                global $conn;
                                $select = "select * from order_info where status = 'Pending'";
                            ...
                            <tr>
                                ...
                                <td><?php echo "<a href='update_pending.php?trans_id=$trans_id'><button class='buy-btn' style=''>Update</button></a>";?></td>
                            </tr>
