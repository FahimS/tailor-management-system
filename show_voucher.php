                              ...
                              <table align="center" width="500" border="2">
                                  <tr>
                                      <td colspan="8" ><h2 align="center">Payment Voucher</h2><br>
                                          <label align="left">Transaction Id: <span><?php echo $tran_id ?></span></label>
                                  ...
                                  <tr>
                                      <td colspan="8" align="center" height="50">
                                          <label >Total Price: <span><?php echo $total ?></span></label><br>
                                          <label >Paid: <span><?php echo $paid ?></span></label><br>
                                          <label >Due: <span><?php echo $due ?></span></label>    
                                      </td>
                                  </tr>
                                  <tr>
                                      <td colspan="8" align="center" height="50">
                                          <label >Customer Name: <span><?php echo $name ?></span></label>
                                      </td>
                                  </tr>             
                                  <tr>
                                      <td colspan="8" align="center" height="50">
                                          <label >Customer phone: <span><?php echo $phone ?></span></label>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td  align="center" width="250" height="50">
                                          <label >Order Date: <span><?php echo $order_date ?></span></label>
                                      </td>
                                      <td  align="center" width="250" height="50">
                                          <label >Delivery Date: <span><?php echo $delivery_date ?></span></label>
                                      </td>
                                  </tr>
                                  <tr>
                                      <td colspan="8" align="center" height="100">
                                          <label >Customer Address: <span><?php echo $address ?></span></label>
                                  ...
                                  <tr>
                                      <td colspan="8" height="50">
                                          <label>Voucher No: <span><?php echo $voucher ?></span></label>
