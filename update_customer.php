...
if(isset($_GET['edit_id'])){
  $sql = "SELECT * from creg WHERE id =" .$_GET['edit_id'];
...
if(isset($_POST['btn-update'])){
  ...
  $update = "UPDATE creg SET name='$name', email='$email' , password='$password', gender='$gender' , mobile='$mobile' , address='$address' WHERE id=". $_GET['edit_id'];
...
<div class="w3-sidebar w3-light-grey w3-bar-block" style="width:20%;top: 0;background-color: #989898 !important;color: #fff !important;font-size: 18px;">
  ...
  <a id="active" href="view_customer.php" class="w3-bar-item w3-button">View Customer</a><br>
...
<label for="email" class="control-label col-sm-3">Email:</label>
 <div class="col-sm-8">
<input id="num" type="text" class="form-control" name="email" placeholder="Username" value="<?php echo $row['email']; ?>">
