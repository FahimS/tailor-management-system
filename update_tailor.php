...
if(isset($_GET['edit_id'])){
  $sql = "SELECT * from treg WHERE id =" .$_GET['edit_id'];
...
if(isset($_POST['btn-update'])){
  ...
  $status = $_POST['status'];
  $update = "UPDATE treg SET name='$name', email='$email' , password='$password' ,  mobile='$mobile' , address='$address', status='$status' WHERE id=". $_GET['edit_id'];
...
<input id="num" type="text" class="form-control" name="mobile" placeholder="Mobile" value="<?php echo $row['mobile']; ?>">
    ...
    <div class="form-group">
<label for="mobile" class="control-label col-sm-3">Status:</label>
<div class="col-sm-8">

<input id="num" type="text" class="form-control" name="status" placeholder="Status" value="<?php echo $row['status']; ?>">
