...
if(isset($_GET['rs_id']))
    ...
    if($opr=="del")
{
        $query="DELETE FROM adlogin WHERE id=$id";
...
<div class="view_admin_darjibari">
    ...
    if($key !="")
    {
        $query="SElECT * FROM adlogin WHERE name  like '%$key%' ";
        $sql_sel=mysqli_query($con,$query);
    }
        
    else
    {
        $query="SELECT * FROM adlogin";
        $sql_sel=mysqli_query($con,$query);
    }
...
<div class="viewad_footersection templete clear">
