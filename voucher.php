  ...
  <body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="voucher.php"><b>Voucher</b></a></li>
    ...
    <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Voucher <small>Manage Voucher</small></h1>
                </div>
                      ...
                      <div class="panel-body">
                          <table class="table table-striped table-hover">
                            ...
                            <tr>
                              ...
                              <td><?php echo $name;?></td>
                              <td><?php echo "<a href='show_voucher.php?voucher_no=$voucher'><button class='buy-btn' style=''>show</button></a>";?></td>
                            </tr>
  ...
  <div class="social2">
    ...
    <?php
        ...
        if(isset($_POST['click'])){
            ...
            if($no_row>0 ){
                echo "<script>alert('Voucher of this transaction id is already created!')</script>";
